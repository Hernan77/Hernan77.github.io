...
# # USE IDLE TO RUN PROGRAMS: TKINTER GUI
# 
...
def main():    
    ...
    monthly_investment_entry = tkinter.StringVar()
    yearly_interest_rate_entry = tkinter.StringVar()
    years_entry = tkinter.StringVar()
    future_value_label = tkinter.StringVar()
