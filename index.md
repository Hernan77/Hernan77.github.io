...
- [TWO NAMING STYLES FOR VARIABLES](MURACHS_PYTHON_PROGRAMMING/TWO_NAMING_STYLES_FOR_VARIABLES.html)
- [PHYTHON ARITHMETIC OPERATORS](MURACHS_PYTHON_PROGRAMMING/PHYTHON_ARITHMETIC_OPERATORS.html)
- [ARITHMETIC EXPRESSIONS TO ASSIGNMENT STATEMENTS](MURACHS_PYTHON_PROGRAMMING/ARITHMETIC_EXPRESSIONS_TO_ASSIGNMENT_STATEMENTS.html)
- [NUMERIC TESTING](MURACHS_PYTHON_PROGRAMMING/NUMERIC_TESTING.html)
- [WORK WITH STRING DATA](MURACHS_PYTHON_PROGRAMMING/WORK_WITH_STRING_DATA.html)
- [SPECIAL CHARACTERS IN STRINGS](MURACHS_PYTHON_PROGRAMMING/SPECIAL_CHARACTERS_IN_STRINGS.html)
- [STRING TESTING](MURACHS_PYTHON_PROGRAMMING/STRING_TESTING.html)
- [HOW TO USE THE PRINT FUNCTION](MURACHS_PYTHON_PROGRAMMING/HOW_TO_USE_THE_PRINT_FUNCTION.html)
- [HOW TO USE THE INPUT FUNCTION](MURACHS_PYTHON_PROGRAMMING/HOW_TO_USE_THE_INPUT_FUNCTION.html)
- [HOW TO USE THE INT, FLOAT, AND ROUND FUNCTIONS](MURACHS_PYTHON_PROGRAMMING/HOW_TO_USE_THE_INT,_FLOAT,_AND_ROUND_FUNCTIONS.html)
- [THE MILES PER GALLON PROGRAM](MURACHS_PYTHON_PROGRAMMING/THE_MILES_PER_GALLON_PROGRAM.html)
- [THE TEST SCORE PROGRAM](MURACHS_PYTHON_PROGRAMMING/THE_TEST_SCORE_PROGRAM.html)
